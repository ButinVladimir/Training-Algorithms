...
{
    [TestClass]
    public class SortedFileSystemTest
    {
        [TestMethod]
        public void Test1()
        {
            SortedFileSystemQuery query = new SortedFileSystemQuery();
            query.AddFileSystem(new SortedFileSystem(new int[] { 1, 3, 5, 10 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 2, 4, 6, 8 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 1, 1, 1 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 11, 12, 13 }));
        ...
        {
            SortedFileSystemQuery query = new SortedFileSystemQuery();
            query.AddFileSystem(new SortedFileSystem(new int[] { 7, 5, 5, 5 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 5, 6, 5 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 1 }));
            query.AddFileSystem(new SortedFileSystem(new int[] { 1050 }));
